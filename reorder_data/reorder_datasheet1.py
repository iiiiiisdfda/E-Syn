...
input_csv_path = os.path.join(parent_dir, 'res_var.csv')
output_csv_delay_path = os.path.join(parent_dir, 'sorted_delay_var.csv')
output_csv_area_path = os.path.join(parent_dir, 'sorted_area_var.csv')
