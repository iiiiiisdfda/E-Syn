...
// sha3: 930694eae8eaf5e0c508100e94d9973642c56f2954a030e7d3f41fd4ef7bdfdc
use crate::Expr;
...
mod __parse__Expr {
    ...
    const __ACTION: &[i8] = &[
        ...
        // State 12
        0, -14, 0, -14, -14, -14, 0, 0, 0, 0, 0,
        // State 13
        0, -11, 0, -11, -11, -11, 0, 0, 0, 0, 0,
        // State 14
        0, -12, 0, -12, -12, -12, 0, 0, 0, 0, 0,
        // State 15
        0, -10, 0, -10, -10, -10, 0, 0, 0, 0, 0,
        // State 16
        0, -13, 0, -13, -13, -13, 0, 0, 0, 0, 0,
        // State 17
        0, -2, 0, -2, -2, -2, 0, 0, 0, 0, 0,
        // State 18
        0, -1, 0, 23, -1, -1, 0, 0, 0, 0, 0,
        // State 19
        ...
        // State 24
        0, -5, 0, -5, -5, -5, 0, 0, 0, 0, 0,
        // State 25
        0, 0, 0, 27, 0, 0, 0, 0, 0, 0, 0,
        // State 26
        0, -5, 0, 28, -5, -5, 0, 0, 0, 0, 0,
        // State 27
        0, -4, 0, -4, -4, -4, 0, 0, 0, 0, 0,
    ];
    ...
    {
        // Expr = "(", NotOp, "(", Expr, Op, Expr, ")", ")" => ActionFn(13);
    ...
    {
        // VariableStr = r#"[a-z_]+[A-Z0-9_]+\\|[a-zA-Z0-9_]+"# => ActionFn(4);
        let __sym0 = __pop_Variant0(__symbols);
        let __start = __sym0.0.clone();
        let __end = __sym0.2.clone();
...
{
    Expr::Not(Box::new(Expr::Lisp(s, Box::new(e1), Box::new(e2))))
}
...
{
    Expr::Lisp(s, Box::new(e1), Box::new(e2))
}
